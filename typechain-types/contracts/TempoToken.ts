...
export interface TempoTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface TempoToken extends BaseContract {
  connect(runner?: ContractRunner | null): TempoToken;
  waitForDeployment(): Promise<this>;

  interface: TempoTokenInterface;
